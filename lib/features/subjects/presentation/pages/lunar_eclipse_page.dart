...
class _LunarEclipsePageState extends State<LunarEclipsePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.lunarEclipseTitle.toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5, fontSize: 16)),
        ...
        children: [
          Container(
            ...
            child: const ModelViewer(
              ...
              src: 'assets/models/lunar_eclipse.glb',
              alt: "A 3D model of a Lunar Eclipse",
              ar: true,
              autoRotate: true,
              autoPlay: true,
              cameraControls: true,
